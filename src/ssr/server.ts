...
import { CmsSearch, GetCmsEntries, GetCmsPage } from "./routes/cms-routes.js";
...
app.get("/api/cms/:pageId", GetCmsPage);

app.get("/api/cms/entries/:contentType", GetCmsEntries);

app.get("/api/cms/search/:searchText", CmsSearch);
  ...
  helmet({
    contentSecurityPolicy: {
      ...
      directives: {
        ...
        "img-src":
          "'self' data: https://images.ctfassets.net https://gist.githubusercontent.com https://res.cloudinary.com",
